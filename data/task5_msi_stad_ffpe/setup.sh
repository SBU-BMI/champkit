...
do_task5() (
    ...
    # Download Task 5 data (STAD FFPE)
    echo "[champkit] Downloading task 5 data..."
    wget $wget_args https://zenodo.org/record/2530835/files/STAD_TEST_MSIMUT.zip?download=1
    wget $wget_args https://zenodo.org/record/2530835/files/STAD_TEST_MSS.zip?download=1
    wget $wget_args https://zenodo.org/record/2530835/files/STAD_TRAIN_MSIMUT.zip?download=1
    wget $wget_args https://zenodo.org/record/2530835/files/STAD_TRAIN_MSS.zip?download=1
    ...
    unzip $unzip_args $DOWNLOAD_DIR/STAD_TEST_MSIMUT.zip -d $IMAGE_DIR/test
    unzip $unzip_args $DOWNLOAD_DIR/STAD_TEST_MSS.zip -d $IMAGE_DIR/test

    unzip $unzip_args $DOWNLOAD_DIR/STAD_TRAIN_MSIMUT.zip -d $IMAGE_DIR/trainval
    unzip $unzip_args $DOWNLOAD_DIR/STAD_TRAIN_MSS.zip -d $IMAGE_DIR/trainval
...
echo "[champkit] Seeing if I should download task 5"
